...
The script runs in a Raspberry Pi Zero W, a Meross smart plug (MSS310R) and uses the messaging app Telegram to communicate with the user.
...
> PS C:\Users\alexl\> `scp "C:\Users\alexl\OneDrive\Documenti\pythonProjects\parental\TvTelegramBot.py" alexl@raspberrypi:tv`

> PS C:\Users\alexl\> `scp "C:\Users\alexl\OneDrive\Documenti\pythonProjects\parental\.env" alexl@raspberrypi:tv`

> PS C:\Users\alexl\> `scp "C:\Users\alexl\OneDrive\Documenti\pythonProjects\parental\calendar_data.json" alexl@raspberrypi:tv`

> PS C:\Users\alexl\> `scp "C:\Users\alexl\OneDrive\Documenti\pythonProjects\parental\config.json" alexl@raspberrypi:tv`

> PS C:\Users\alexl\> `scp "C:\Users\alexl\OneDrive\Documenti\pythonProjects\parental\tvTelegram.service" alexl@raspberrypi:tvTelegram.service`

alexl@raspberrypi:~ \$ `exit`

Conversely if you want to copy using ssh, the command is:

- alexl@raspberrypi:~ \$ `sudo cp tvTelegram.service/lib/systemd/system/tvTelegram.service`

Giving rights to the file:

- alexl@raspberrypi:~ \$ `sudo chmod 644 /lib/systemd/system/tvTelegram.service`
...
alexl@raspberrypi:~ \$ `sudo systemctl enable tvTelegram`

alexl@raspberrypi:~ \$ `sudo systemctl start tvTelegram`

to check the status:

- alexl@raspberrypi:~ \$ `systemctl status tvTelegram.service`
...
- alexl@raspberrypi:~ \$ `sudo systemctl stop tvTelegram`

disable at startup:

- alexl@raspberrypi:~ \$ `sudo systemctl disable tvTelegram`
